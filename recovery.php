        ...
        <div class="main">
            <div class="content">
                ...
                <div class = "login">
                    ...
                    <input name="_login" type="text" placeholder="E-mail@mail.ru" onkeypress="return PressToEnter(event)"/>
                    
                    <input type="button" class="button" value="Отправить" onclick="RecoveryPassword()" style="margin-top: 0px;"/>
